                            ...
                            <div class="card-body">
                                <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.ticket.ticket-detail') }}" class="fw-bold text-secondary">#Tc-0002</a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.ticket.ticket-detail') }}" class="fw-bold text-secondary">#Tc-0006</a>
                                            </td>
                                            <td>
                                                Salary Amount wrong 
                                            </td>
                                         ...
                                         <tr>
                                            <td>
                                                <a href="{{ route('admin.ticket.ticket-detail') }}" class="fw-bold text-secondary">#Tc-0004</a>
                                            </td>
                                            <td>
                                               Mouse Not working
                                            </td>
                                         ...
                                         <tr>
                                            <td>
                                                <a href="{{ route('admin.ticket.ticket-detail') }}" class="fw-bold text-secondary">#Tc-00011</a>
                                            </td>
                                            <td>
                                         ...
                                         <tr>
                                            <td>
                                                <a href="{{ route('admin.ticket.ticket-detail') }}" class="fw-bold text-secondary">#Tc-00021</a>
                                            </td>
                                            <td>
                                                Leave Balance Wrong
                                              </td>
                                         ...
                                         <tr>
                                            <td>
                                                <a href="{{ route('admin.ticket.ticket-detail') }}" class="fw-bold text-secondary">#Tc-00041</a>
                                            </td>
                                            <td>
                                                Display Blur
                                            </td>
