                            ...
                            <div class="row align-items-center">
                                <div class="col-12 col-md-5 col-lg-6 order-md-2 ">
                                    <div class="text-center p-4">
                                        <img src="{{ url('/').'/images/task-view.svg' }}" alt="..." class="img-fluid">
                                    </div>
                                </div>
                    ...
                    <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="{{ route('admin.project.index') }}">Social Geek Made</a></td>
                                            <td>10-01-2021</td>
                                            <td>4 Month</td>
                                            <td><img src="{{ url('/').'/images/xs/avatar1.jpg' }}" alt="Avatar" class="avatar sm  rounded-circle me-2"><a href="#">Keith</a></td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td><a href="{{ route('admin.project.index') }}">Practice to Perfect</a></td>
                                            <td>12-02-2021</td>
                                            <td>1 Month</td>
                                            <td><img src="{{ url('/').'/images/xs/avatar2.jpg' }}" alt="Avatar" class="avatar sm rounded-circle me-2"><a href="#">Colin</a></td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td><a href="{{ route('admin.project.index') }}">Rhinestone</a></td>
                                            <td>18-02-2021</td>
                                            <td>2 Month</td>
                                            <td><img src="{{ url('/').'/images/xs/avatar3.jpg' }}" alt="Avatar" class="avatar sm rounded-circle me-2"><a href="#">Adam</a></td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td><a href="{{ route('admin.project.index') }}">Box of Crayons</a></td>
                                            <td>23-02-2021</td>
                                            <td>1 Month</td>
                                            <td><img src="{{ url('/').'/images/xs/avatar4.jpg' }}" alt="Avatar" class="avatar sm rounded-circle me-2"><a href="#">Peter</a></td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td><a href="{{ route('admin.project.index') }}">Gob Geeklords</a></td>
                                            <td>16-03-2021</td>
                                            <td>10 Month</td>
                                            <td><img src="{{ url('/').'/images/xs/avatar5.jpg' }}" alt="Avatar" class="avatar sm rounded-circle me-2"><a href="#">Evan</a></td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td><a href="{{ route('admin.project.index') }}">Java Dalia</a></td>
                                            <td>17-03-2021</td>
                                            <td>8 Month</td>
                                            <td><img src="{{ url('/').'/images/xs/avatar6.jpg' }}" alt="Avatar" class="avatar sm rounded-circle me-2"><a href="#">Connor</a></td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td><a href="{{ route('admin.project.index') }}">Fast Cad</a></td>
                                            <td>14-04-2021</td>
                                            <td>2 Month</td>
                                            <td><img src="{{ url('/').'/images/xs/avatar7.jpg' }}" alt="Avatar" class="avatar sm rounded-circle me-2"><a href="#">Benjamin</a></td>
                                            <td>
                                                <div class="progress">
