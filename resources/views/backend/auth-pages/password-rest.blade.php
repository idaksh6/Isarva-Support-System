                ...
                <div class="w-100 p-4 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                    ...
                    <form class="row g-1 p-0 p-4">
                        <div class="col-12 text-center mb-5">
                            <img src="{{asset('/images/forgot-password.svg')}}" class="w240 mb-4" alt="" />
                        ...
                        <div class="col-12 text-center mt-4">
                            <a href="{{route('admin.authentication.signin')}}" title="" class="btn btn-lg btn-block btn-light lift text-uppercase">SUBMIT</a>
                        </div>
                        <div class="col-12 text-center mt-4">
                            <span class="text-muted"><a href="{{route('admin.authentication.signup')}}" class="text-secondary">Back to Sign in</a></span>
                        </div>
                    </form>
                    <!-- End Form -->
