...
@section('title', __('2 Step Authentication'))
                    ...
                    <div class="w-100 p-4 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                        ...
                        <form class="row g-1 p-0 p-4">
                            <div class="col-12 text-center mb-5">
                                <img src="{{asset('/images/verify.svg')}}" class="w240 mb-4" alt="" />
                                <h1>Verification</h1>
                            ...
                            <div class="col-12 text-center mt-4">
                                <a href="{{route('admin.dashboard')}}" title="" class="btn btn-lg btn-block btn-light lift text-uppercase">Verify my account</a>
                            </div>
                            <div class="col-12 text-center mt-4">
