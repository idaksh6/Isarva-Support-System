...
@else
    ...
    {{-- @if ($user->isMasterAdmin() && $logged_in_user->isMasterAdmin())
        <!-- <div class="dropdown d-inline-block">
            <a class="btn btn-secondary dropdown-toggle" id="moreMenuLink" href="#" role="button" data-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false">
                @lang('More')
            </a>
